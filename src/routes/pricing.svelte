...
<div>
  ...
  <div class="bg-white">
    <div class="bg-gradient-to-b from-blue-50 via-white to-white">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <h2
              class="text-base font-semibold text-blue-600 uppercase tracking-wide"
            >
              Everything you need
            </h2>
    ...
    <div class="bg-blue-900">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 border-t border-blue-400 border-opacity-25 pt-10">
          <dl
            class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12"
          >
            <div>
    ...
    <div class="bg-blue-50">
      ...
      >
        <h2
          class="text-3xl font-extrabold tracking-tight text-blue-900 sm:text-4xl"
        >
